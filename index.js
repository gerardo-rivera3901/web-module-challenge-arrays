...
let aaa = originalFlavors.length;
...
function removeLastFlavor(newArr){
    newArr.pop();
    newArr2 = newArr;
}
...
function getFlavorByIndex(newArr2, index){
    return newArr2[index];
}
...
let pos = originalFlavors.indexOf('Vanilla')
function removeFlavorByName(newArr3, flavor){
    let newArr4 = originalFlavors.splice(pos, 30)
    console.log(newArr3)
